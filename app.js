    ...
    ALL.map(c=>`
      <div class="bank-token">
        ...
        <button
          ...
          class="bank-coin ${c}"
          data-bank="${c}"
          aria-label="${LABEL[c]} zseton, ${state.bank[c]} darab"
        >
          <span class="bank-symbol">${c==="gold" ? "★" : "●"}</span>
        </button>

        <small>
          <i class="bank-color-dot ${c}"></i>${LABEL[c]} · ${state.bank[c]}
        </small>
    ...
    state.players.map(x=>`
      <div class="player ${
        ...
        <div class="player-assets">
          <span class="owned-cards" title="Birtokolt kártyák">
            <span class="owned-card-icon" aria-hidden="true"></span>
            <span class="owned-card-number">${x.cards.length}</span>
            <span>kártya</span>
          </span>

          <span class="owned-nobles" title="Megszerezett nemesek">
            <span class="noble-icon" aria-hidden="true">♛</span>
            <span>${x.nobles.length}</span>
            <span>nemes</span>
          </span>
        </div>
        ...
        <div class="reserved">
          ...
          ${
            x.reserved.length
              ? ` · <span class="reserved-link">Megnézem</span>`
              : ""
          }
        </div>
